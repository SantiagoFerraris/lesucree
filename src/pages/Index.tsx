        ...
        <div className="max-w-xl">
          ...
          <div className="flex flex-col sm:flex-row gap-3 mt-8">
            <a
              ...
              className="inline-flex items-center justify-center gap-2 rounded-full bg-[#25D366] text-white px-8 py-4 text-[14px] font-semibold uppercase tracking-[0.12em] hover:bg-[#1da851] hover:scale-[1.02] transition-all duration-300 active:scale-95 shadow-lg animate-whatsapp-pulse"
            >
  ...
  return (
    <section ref={reveal.ref} className="py-16 md:py-20 px-4 bg-blush">
      <div className={`container text-center ${reveal.isVisible ? "animate-fade-in-up" : "opacity-0"}`}>
        <h2 className="font-script text-[32px] sm:text-[40px] md:text-[52px] text-espresso">¿Querés hacer un pedido?</h2>
        <p className="font-body text-base text-espresso/70 mt-3 max-w-lg mx-auto">
          Escribime por WhatsApp y te ayudo a elegir el postre perfecto para tu ocasión. ¡Te respondo enseguida!
        </p>
        <a
          href={WHATSAPP_URL}
          target="_blank"
        ...
        <p className="text-xs text-espresso/50 mt-4">Producción limitada por día · Pedidos con 48hs de anticipación</p>
      </div>
    </section>
  );
}
