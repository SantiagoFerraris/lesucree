        ...
        <section className="pt-[72px]">
              ...
              <div className="py-10 sm:py-16 md:py-20 px-3 sm:px-4">
                      <div className="container">
                                <h1 className="font-script text-[28px] sm:text-[36px] md:text-[48px] text-espresso text-center">Contactanos</h1>h1>
                                <SectionDivider />
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-8 sm:gap-12 mt-8 sm:mt-12 max-w-4xl mx-auto">
                                  {/* Info */}
                                            <div className="space-y-6">
                                                          <div>
                                                                          <h3 className="font-body text-xs uppercase tracking-[0.08em] text-warm-gray">Información de contacto</h3>h3>
                                                                          <div className="mt-4 space-y-3">
                                                                                            <a href={whatsappUrl} target="_blank" rel="noopener noreferrer" className="flex items-center gap-3 text-espresso/70 hover:text-dusty-pink transition-colors">
                                                                                                                <span className="text-lg">📱</span>span> WhatsApp
                                                                                              </a>a>
                                                          ...
                                                          <div>
                                                                          <h3 className="font-body text-xs uppercase tracking-[0.08em] text-warm-gray">Ubicación</h3>h3>
                                                                          <div className="mt-3 flex items-start gap-3 text-espresso/70">
                                                                                            <MapPin size={18} className="flex-shrink-0 mt-0.5" />
                                                                                            <p className="text-sm leading-relaxed">{address}</p>p>
                                                                          </div>div>
                                                          </div>div>
                                            
                                                          <div>
                                                                          <h3 className="font-body text-xs uppercase tracking-[0.08em] text-warm-gray">Horarios de retiro</h3>h3>
                                                                          <div className="mt-3 flex items-start gap-3 text-espresso/70">
                                ...
                                <p key={i}>{line}</p>p>
                                                                                                                ...
                                                                                                                <p className="mt-1 text-xs text-warm-gray/70">Pedidos con al menos 48hs de anticipación</p>p>
                                                                                              </div>div>
                                                                          </div>div>
                                                          </div>div>
                                            </div>div>
                                  ...
                                  {/* Form */}
                                            <form onSubmit={handleSubmit} className="space-y-4">
                                                          ...
                                                          <div>
                                                                          <label htmlFor="contacto-name" className="sr-only">Nombre</label>label>
                                                          ...
                                                          <div>
                                                                          <label htmlFor="contacto-email" className="sr-only">Email</label>label>
                                                          ...
                                                          <div>
                                                                          <label htmlFor="contacto-phone" className="sr-only">Teléfono</label>label>
                                                          ...
                                                          <div className="relative">
                                                                          <label htmlFor="contacto-message" className="sr-only">Mensaje</label>label>
                                                                          ...
                                                                          <span className="absolute bottom-2 right-3 text-xs text-warm-gray/50">{form.message.length}/{MAX_MESSAGE_LENGTH}</span>span>
                                                          </div>div>
                        ...
                        {/* WhatsApp CTA */}
                                <div className="text-center mt-16">
                                            <a href={whatsappUrl} target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 rounded-full bg-[#25D366] text-white px-8 py-3.5 text-[15px] font-semibold uppercase tracking-[0.1em] hover:bg-[#1da851] hover:scale-[1.02] transition-all duration-300 active:scale-95">
