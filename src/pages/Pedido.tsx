                ...
                <section className="pt-[72px]">
                        <div className="py-20 px-4">
                                  <div className="container max-w-lg text-center">
                                              ...
                                              <p className="text-espresso/70 mt-4">Pedido #{success.id}</p>p>
          ...
          return (
                  <section className="pt-[72px]">
                          <div className="py-20 px-4 text-center">
                                    ...
                                    <p className="text-espresso/70 mt-3">Agregá productos desde nuestro catálogo para armar tu pedido.</p>p>
          ...
          <section className="pt-[72px]">
                ...
                <div className="py-16 md:py-20 px-4">
                        <div className="container">
                                  ...
                                  <SectionDivider />
                                  <p className="text-center text-sm text-espresso/60 mt-4 mb-12">Retiro en local — {pickupAddress}</p>p>
                                  ...
                                  <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 max-w-5xl mx-auto">
                                    {/* Form */}
                                              <form onSubmit={handleSubmit} className="space-y-4">
                                                            ...
                                                            <div>
                                                                            <label htmlFor="pedido-name" className="text-xs font-semibold text-warm-gray uppercase tracking-wider">Nombre completo *</label>label>
                                                              ...
                                                              {touched.name && errors.name && <p className="text-xs text-red-500 mt-1">{errors.name}</p>p>}
                                                            </div>div>
                                              
                                                            <div>
                                                                            <label htmlFor="pedido-phone" className="text-xs font-semibold text-warm-gray uppercase tracking-wider">Teléfono *</label>label>
                                                              ...
                                                              {touched.phone && errors.phone && <p className="text-xs text-red-500 mt-1">{errors.phone}</p>p>}
                                                            </div>div>
                                              
                                                            <div>
                                                                            <label htmlFor="pedido-email" className="text-xs font-semibold text-warm-gray uppercase tracking-wider">Email *</label>label>
                                                              ...
                                                              {touched.email && errors.email && <p className="text-xs text-red-500 mt-1">{errors.email}</p>p>}
                                                            </div>div>
                                              
                                                            <div>
                                                                            <label htmlFor="pedido-date" className="text-xs font-semibold text-warm-gray uppercase tracking-wider">Fecha de retiro *</label>label>
                                                              ...
                                                              {touched.date && errors.date && <p className="text-xs text-red-500 mt-1">{errors.date}</p>p>}
                                                            </div>div>
                                              
                                                            <div>
                                                                            <label htmlFor="pedido-time" className="text-xs font-semibold text-warm-gray uppercase tracking-wider">Horario preferido *</label>label>
                                                                            <select id="pedido-time" value={form.time} onChange={e => setForm(p => ({ ...p, time: e.target.value }))} className={`${inputBase} border-input focus:ring-dusty-pink/30`}>
                                                                              {timeOptions.map(opt => (
                                <option key={opt}>{opt}</option>option>
                              ))}
                                                                            </select>select>
                                                            </div>div>
                                              
                                                            <div>
                                                                            <label htmlFor="pedido-notes" className="text-xs font-semibold text-warm-gray uppercase tracking-wider">Notas adicionales</label>label>
                                                      ...
                                                      <div className="flex-1 min-w-0">
                                                        ...
                                                        {item.variantLabel && <p className="text-xs text-warm-gray">{item.variantLabel}</p>p>}
                                                                              <div className="flex items-center gap-2 mt-1">
                                                                                                        ...
                                                                                                        <span className="text-xs font-semibold text-espresso w-4 text-center">{item.quantity}</span>span>
                                                                                                        <button onClick={() => updateQuantity(item.productId, item.variantId, item.quantity + 1)} className="w-6 h-6 rounded-full border border-warm-gray/30 flex items-center justify-center text-warm-gray hover:border-dusty-pink hover:text-dusty-pink transition-colors">
                                                                                                                                    <Plus size={10} />
                                                                                                          </button>button>
